...
[`generate_report.py`](generate_report.py) checks the rescue status of the example data sources and writes the results to `index.qmd`, the home page of the site below.
