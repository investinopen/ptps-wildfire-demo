...
// the elements over the map that labels shouldn't go under -- MapLibre's own controls in its corners, and the sidebar toggle (the legend etc. are in the sidebar beside the map)
