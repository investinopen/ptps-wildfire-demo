// the button that collapses/expands the sidebar (the legend, scale, and attribution), so the map can take the whole width. Remembered per browser; the sidebar always shows in print regardless (see index.css).
