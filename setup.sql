...
CREATE OR REPLACE SECRET source_coop (
        ...
        URL_STYLE 'path' -- If you're working with multiple S3-compatible sources (beyond the Data Proxy), you'll want to only apply this SECRET to the Source Cooperative account name(s).
